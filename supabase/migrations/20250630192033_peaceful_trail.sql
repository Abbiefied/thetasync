/*
  ...
  2. Security
    ...
    - Add policies for group members to send, view, edit, and delete messages
    - Users can only edit/delete their own messages
    - Users can only view messages from groups they belong to

  3. Functions
    - Add trigger to update `updated_at` timestamp
    - Add trigger to set `is_edited` flag when message is updated
*/
